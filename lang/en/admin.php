...
$string['configdocroot'] = 'Defines the path to the Moodle Docs for providing context-specific documentation via \'\' links in the footer of each page. If the field is left blank, links will not be displayed.';
